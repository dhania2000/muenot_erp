...
export function SupportClient() {
  ...
  return <main className="space-y-6 p-6"><div className="flex items-center justify-between"><div><h1 className="text-2xl font-semibold">HR Support</h1><p className="text-muted-foreground">Employee helpdesk tickets, ownership, SLA, and resolution tracking.</p></div><div className="flex items-center gap-2"><ExcelExportButton rows={tickets} filename="support-tickets" columns={[{ header: "Ticket", value: (r: any) => r.ticket_id },{ header: "Employee", value: (r: any) => r.employee_name },{ header: "Subject", value: (r: any) => r.subject },{ header: "Category", value: (r: any) => r.support_category },{ header: "Priority", value: (r: any) => r.priority },{ header: "Status", value: (r: any) => r.status },{ header: "SLA Due", value: (r: any) => r.sla_due_date }]} /><Button onClick={() => setOpen(!open)}>New ticket</Button></div></div>
