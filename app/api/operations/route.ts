...
export async function POST(request: Request) {
  ...
  const allowed: Record<Kind, string[]> = {
    ...
    tasks:["project_id","project_name","task_title","description","task_type","assigned_to","reporter","priority","start_date","due_date","estimated_hours","actual_hours","completion_percent","board_stage","status","remarks"],
    work_orders:["work_order_no","project_id","client_name","title","description","work_type","assigned_to","requested_by","priority","start_date","due_date","estimated_cost","actual_cost","status","remarks"],
