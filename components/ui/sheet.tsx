  ...
  return (
    <SheetPrimitive.Portal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed inset-y-0 z-50 flex h-full w-full max-w-md flex-col gap-4 overflow-y-auto bg-popover p-5 text-sm text-popover-foreground shadow-lg ring-1 ring-foreground/10 duration-200 outline-none data-open:animate-in data-closed:animate-out",
          side === "right"
