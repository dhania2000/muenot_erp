...
const safePrefixes = new Set(["EMP", "INV", "FIN", "GST", "TDS", "JE", "GL", "RPT", "PROJ", "TKT", "CLI", "PROD", "LEAD", "COMP", "MEET", "QUOTE", "CONT", "ONB", "FORE", "REG", "LR", "DOC", "SHIFT", "EXP", "FTE", "FRL", "BTX", "ACC", "COA", "CV", "PB"])
