...
export const CONFIG_REGISTRY: ConfigDescriptor[] = [
  ...
  {
    key: "security.mfa_mode",
    label: "MFA enforcement mode",
    description:
      "Tenant-wide MFA requirement enforced at sign-in: disabled, optional, required_all, required_admins or required_roles.",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "optional",
  ...
  {
    key: "security.mfa_grace_period_days",
    label: "MFA enrollment grace period (days)",
    description: "Days a newly mandated user may sign in without MFA before enrollment is enforced.",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "14",
  },
  {
    ...
    description: "Comma-separated tenant roles that must use MFA when the mode is required_roles.",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "",
  ...
  {
    key: "security.mfa_exempted_users",
    label: "MFA exempt users",
    description: "Comma or newline separated emails exempted from the MFA requirement (e.g. break-glass accounts).",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "",
  ...
  {
    key: "security.mfa_policy_effective_at",
    label: "MFA policy effective date",
    description: "Timestamp the current MFA mandate started; anchors the enrollment grace period. Managed by the system.",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "",
  ...
  {
    key: "security.mfa_allowed_methods",
    label: "Allowed MFA methods",
    description: "Comma-separated factors offered for MFA enrollment (totp, backup_codes, sms).",
    category: "security",
    scope: "tenant",
    secret: false,
    default: "totp,backup_codes",
  },
  {
    key: "security.mfa_recovery_policy",
    label: "MFA recovery policy",
    description: "How users recover MFA access: self_service, admin_approval or disabled.",
    category: "security",
    scope: "tenant",
    secret: false,
