...
const rawSections: Omit<SettingSection, "module" | "submodule">[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "security.password_require_case", label: "Require Upper &amp; Lower Case", type: "toggle", options: yesNo, default: "Enabled" },
      { key: "security.password_require_number", label: "Require a Number", type: "toggle", options: yesNo, default: "Enabled" },
      { key: "security.password_require_symbol", label: "Require a Symbol", type: "toggle", options: yesNo, default: "Disabled" },
      { key: "security.password_expiry_days", label: "Password Expiry (days)", type: "number", default: "90" },
      { key: "security.password_reuse_history", label: "Reuse History (last N passwords)", type: "number", default: "5" },
      { key: "security.max_login_attempts", label: "Max Login Attempts", type: "number", default: "5" },
      { key: "security.lockout_duration_minutes", label: "Lockout Duration (minutes)", type: "number", default: "15" },
      { key: "security.temp_password_expiry_hours", label: "Temporary Password Expiry (hours)", type: "number", default: "24" },
