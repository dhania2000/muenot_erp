...
Object.assign(IMPORT_CONFIGS, {
  clients: {
    ...
    columns: [
      ...
      { key: "legal_name", label: "Legal Name", sample: "Acme Technologies Private Limited" },
      { key: "client_type", label: "Client Type", default: "Company", sample: "Company" },
      ...
      { key: "payment_terms_days", label: "Payment Terms (days)", type: "number", sample: "30" },
