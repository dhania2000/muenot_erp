...
const safePrefixes = new Set(["EMP", "INV", "FIN", "GST", "TDS", "JE", "GL", "VCH", "RPT", "PROJ", "TKT", "CLI", "PROD", "LEAD", "COMP", "MEET", "QUOTE", "CONT", "ONB", "FORE", "REG", "LR", "DOC", "SHIFT", "EXP", "FTE", "FRL", "BTX", "ACC", "LADJ", "LQE", "COA", "CV", "PB", "REQ", "CAM", "CAND", "SCR", "INT", "ASM", "SEL", "SRC", "SET", "LTR", "JOB", "JAP", "ISC", "OFL", "JSK", "LT", "ROT", "RTV", "RSQ", "RTE", "HRE"])
