...
-- (also self-created automatically by lib/password-reset.ts if missing)
-- -------------------------------------------------------------
...
CREATE TABLE `sales_leads` (
  ...
  `assigned_to` INT UNSIGNED DEFAULT NULL,
	`status` ENUM('New','Qualified','Follow Up 1','Follow Up 2','Follow Up 3','Follow Up 4','Follow Up 5','Follow Up 6','Follow Up 7','In Discussion','Proposal Sent','Ready','Won','Lost') NOT NULL DEFAULT 'New',
...
CREATE TABLE IF NOT EXISTS `sales_emails` (
  ...
  `thread_id` VARCHAR(160) DEFAULT NULL,
  `recipient_key` VARCHAR(120) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_emails_recipient` (`recipient_key`),
