...
import type { SalesEmailStatus } from "@/lib/sales/sales-email-shared"

const STYLES: Record<string, string> = {
  Sent: "bg-emerald-100 text-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-300",
  Opened: "bg-blue-100 text-blue-800 dark:bg-blue-950/50 dark:text-blue-300",
...
export function SalesEmailStatusBadge({ status }: { status: SalesEmailStatus | string }) {
  return (
