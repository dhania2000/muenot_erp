...
const FINANCE_CHILDREN: { label: string; href: string; feature: string }[] = [
  ...
  { label: "Sales Invoices", href: "/modules/finance?module=sales-invoices", feature: "finance.view_dashboard" },
  { label: "Purchase Bills", href: "/modules/finance?module=purchase-bills", feature: "finance.view_dashboard" },
  { label: "Expenses", href: "/modules/finance?module=expenses", feature: "finance.view_dashboard" },
  { label: "FTE Invoices", href: "/modules/finance?module=fte-invoices", feature: "finance.view_dashboard" },
  { label: "Freelance Invoices", href: "/modules/finance?module=freelance-invoices", feature: "finance.view_dashboard" },
  { label: "Bank Transactions", href: "/modules/finance?module=bank-transactions", feature: "finance.view_dashboard" },
  { label: "Bank & Cash", href: "/modules/finance?module=bank-cash", feature: "finance.view_dashboard" },
  { label: "Chart of Accounts", href: "/modules/finance?module=chart-of-accounts", feature: "finance.view_dashboard" },
  { label: "Customer / Vendor", href: "/modules/finance?module=customers-vendors", feature: "finance.view_dashboard" },
...
const OPERATIONS_CHILDREN: { label: string; href: string; feature: string }[] = [
  ...
  { label: "Resources", href: "/modules/operations?module=resources", feature: "operations.view_dashboard" },
  { label: "Projects", href: "/modules/operations?module=projects", feature: "operations.view_dashboard" },
  { label: "Allocations", href: "/modules/operations?module=allocations", feature: "operations.view_dashboard" },
  { label: "Quality & SLA Reviews", href: "/modules/operations?module=quality", feature: "operations.view_dashboard" },
  { label: "Issues", href: "/modules/operations?module=issues", feature: "operations.view_dashboard" },
